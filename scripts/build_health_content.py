# -*- coding: utf-8 -*-
"""
Builder script to generate complete trilingual (UZ, EN, RU) health content
matching exact pictures and articles from Desktop 'body basics'.
"""
import json
import os
...
print("Base definition verified.")
